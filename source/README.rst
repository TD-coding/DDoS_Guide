...
.. figure:: /_static/standard_ddos_syn_flood.png
   :width: 90%
   :alt: Example of a Standard DDoS SYN Flood

   Example of a standard DDoS SYN Flood
...
.. figure:: /_static/dns_reflection.png
   :width: 90%
   :alt: Example of a DNS Reflection DDoS with Amplification

   Example of a DNS Reflection DDoS with Amplification
...
.. figure:: /_static/loic.png
   :width: 90%
   :alt: LOIC Graphical User Interface

   LOIC Graphical User Interface
